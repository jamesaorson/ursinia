                 ...
                 `((header
                   ...
                   (div
                     (div
                       ...
                       (p
                         ...
                         (a (@ (href "https://bible.ursinia.net/versions/bsb/#1-corinthians"))
                            "1 Corinthians 14:33")
                         ", and His will is the only certain course for orderly action ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb/#john"))
                            "John 14:6")
                         "). Therefore, consult the Lord in all you do ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb/#proverbs"))
                            "Proverbs 3:5-6")
                         "), listening to the groans of the spirit ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb/#romans"))
                            "Romans 8:26")
                       ...
                       (h3 "Through marriage")
                       (p
                         (a (@ (href "https://papa.ursinia.net"))
                            "Papa's")
                         " marriage to "
                         (a (@ (href "https://mama.ursinia.net"))
                            "Mama")
                         " demonstrates the profound mystery of Christ's love of the church ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#ephesians"))
                            "Ephesians 5:31-32")
                         ...
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#psalms"))
                            "Psalm 127:3-5")
                         ").")
                       (h3 "In Christ")
                       (p
                         "As we live, let our focus and effort be for Christ and His kingdom ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#philippians"))
                            "Philippians 1:21-24")
                         "), and treat our lives as forfeit to Christ who redeemed us ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#matthews"))
                            "Matthew 16:25")
                     ...
                     (div
                       ...
                       (p
                         ...
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#exodus"))
                            "Exodus 2:22")
                         ", "
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#psalms"))
                            "Psalm 137:4")
                         ", "
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#acts"))
                            "Acts 7:6")
                         ", with our hearts set upon eternity with Christ on the new Earth ("
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#revelation"))
                            "Revelation 21:1-4")
                         ").")
                       (h3 "Our Calling")
                       ...
                       (p
                         ...
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#matthew"))
                            "Matthew 28:17-20")
                         ...
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#colossians"))
                            "Colossians 3:18-24")
                         ", "
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#ephesians"))
                            "Ephesians 1:11")
                         ", "
                         (a (@ (href "https://bible.ursinia.net/versions/bsb#hebrews"))
                            "Hebrews 9:14-15")
                   ...
                   (div (@ (class "family-photoframe"))
                        ...
                        (div
                          ...
                          (span
                            (a (@ (href "https://harmony.ursinia.net"))
                               (img (@ (width "15%")
