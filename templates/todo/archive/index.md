...
- [x] Workout
- [x] Litter Boxes
- [ ] Admin tasks (open mail, pay bills, trade stocks, etc.)
...
Install new house lock

Run trash/boxes to the dump
...
- [x] Family worship - Evening
- Pick 1+ on weekdays:
  - [ ] SVRBC - confession site
  - [ ] Open Source - Raygui App template
  - [ ] Open Source - Raygui API parser
  - [ ] Ursinia - Charter
...
- [x] Litter Boxes
- [ ] Admin tasks (open mail, pay bills, trade stocks, etc.)
- [ ] Family worship - Morning
- [x] Family worship - Evening
- Pick 1+ on weekdays:
  - [x] SVRBC - confession site
  - [ ] Open Source - Raygui App template
  - [ ] Open Source - Raygui API parser
  - [ ] Ursinia - Charter
  - [ ] Ursinia - Papa Theology
...
- [x] Workout
- [x] Litter Boxes
- [x] Admin tasks (open mail, pay bills, trade stocks, etc.)
- [ ] Family worship - Morning
- [x] Family worship - Evening
- Pick 1+ on weekdays:
  - [ ] SVRBC - confession site
  - [x] Open Source - Raygui App template
  - [ ] Open Source - Raygui API parser
  - [ ] Ursinia - Charter
  - [ ] Ursinia - Papa Theology
  - [ ] ExoKomodo - Reformer
...
Fill out loan pre-approval documents
...
Abate roof pooling with scuppers

Abate swale flooding with water pump
...
## March 4th through 12th, 2024

Big gap as I just spent time tiling the floor and getting our bedroom
usable. I also dropped one of the classes from my Master's and will
likely not go back to school.

I finished the following things during the gap

New phones for [Papa](/papa) and [Mama](/mama)

Plumber - replaced shut-off valve

Bathroom - replace termite-damaged wood

Tile - scrape up linoleum

Bathroom - paint walls
...
Bathroom - Home depot to get wood
...
INCIDENT - fire department uncovers buried shutoff and turns it off

INCIDENT - clean up water

INCIDENT - shutoff valve begins to fail and water is spraying again

INCIDENT - turn off water by the stree

INCIDENT - call plumber to tighten active leaks

INCIDENT - get water turned on
...
Prepare den for father to sleep
...
HPCA - Prepare midterm materials
...
February 10, Nathan and Papa went to the [Computer History
Museum](https://computerhistory.org/), Google's HQ, Sony HQ, and Roblox
HQ!

February 11, the whole family took Nathan to Henry Cowell Redwood State
Park!

February 16, went to dump and threw away 1,000 lbs of trash!

February 17, added 3 new massive shelves to garage, fully cleaning out
the garage!
...
HPCA - Work on counters for project 1
...
Home Depot - Get water pumps from, for swale
...
Check milestone 1 on Mac, fixing the audit
...
Abate roof pooling with water pumps
...
Work in toddler room at church
...
Work super late on that one incident...

Check on chickens

Refresh chicken bedding
...
Go to [Happy Hollow](https://happyhollow.org/)
...
Buy a bike - [Trek Marlin 6 Gen
3](https://www.trekbikes.com/us/en_US/bikes/mountain-bikes/cross-country-mountain-bikes/marlin/marlin-6-gen-3/p/40962/?colorCode=reddark_bluedark)

Buy a bike carriage - [Burley Encore X Bike
Trailer](https://www.rei.com/product/221554/burley-encore-x-bike-trailer)

Reorganize the living room without the TV
...
Buy a double stroller - [Burley Encore X Bike
Trailer](https://www.rei.com/product/221554/burley-encore-x-bike-trailer)
...
Take down Christmas house lights
...
Bake crackers - created Crunchable™
...
Move stuff back into shed and garage
...
Nap [Sunshine](/sunshine) at horse barn

Get ill with [Cyclical Vomiting Syndrome
(CVS)](https://medlineplus.gov/download/genetics/condition/cyclic-vomiting-syndrome.pdf),
a year anniversary from my triple syncopatic episode
...
Removed indoor cardboard

Care for sick wife

Finish Bible reading plan with [Mama](/mama)
...
Prepare Christmas cards for post
...
Remove trash from front and side of house

Make front and side walkable

Collect various tools from property
...
Prune all backyard trees

Car shopping with [Mama](/mama)
...
Collapse boxes by compost

Spread more mulch from front to back
...
Peter's Bakery for San Jose Monopoly
...
Feed grass sprouts to chickens

Move dirt further back from front, getting it away from cars and for the
fence to go up
